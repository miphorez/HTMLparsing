...
//    function GetItemPath: string;
  ...
  public
    ...
    procedure SetTableName(TableName, FieldName, FildIdName:string);
    ...
    procedure SetEdit(iTE: TTypeEdit; ID: integer); overload;
...
implementation
//uses
//    uADO, uXMLSettings, Registry, uScriptList, uFields;
...
case iTypeEdit of
     teSiteName:;// SendMessage(smHandle, WM_SM_FOR_SETTINGS, CMD_SETTNGS_SYS_OPENFILE, 0);
end;
end;
...
procedure Tfr_EditSave.SetEdit(iTE: TTypeEdit; ID: integer);
var Reg: TRegistry;
  iStr: string;
begin
ItemID:= ID;
...
procedure Tfr_EditSave.SetTableName(TableName, FieldName, FildIdName: string);
begin
SaveTable:=  TableName;
SaveField:=  FieldName;
SaveFieldID:= FildIdName;
end;
